package com.demo.listdemo.board.controller;
...
import com.demo.listdemo.board.service.BoardService;
import com.demo.listdemo.board.vo.ArticleVO;
import com.demo.listdemo.board.vo.ImageVO;
import com.demo.listdemo.member.vo.MemberVO;

@Controller("boardController")
public class BoardControllerImpl implements BoardController {
	private static final String ARTICLE_IMAGE_REPO = "\\Users\\scbae\\Documents\\java-web\\board_ariticle";
	...
	// 한 개 이미지 글쓰기
		...
		@ResponseBody
		public ResponseEntity addNewReply(@RequestParam("articleNO") int parentNO
	...
	private String upload(MultipartHttpServletRequest multipartRequest) throws Exception {
		...
		while (fileNames.hasNext()) {
			...
			if (mFile.getSize() != 0) { // File Null Check
				...
				mFile.transferTo(new File(ARTICLE_IMAGE_REPO + "\\" + imageFileName)); // 임시로 저장된 multipartFile을 실제 파일로
																						// 전송
			}
		}
